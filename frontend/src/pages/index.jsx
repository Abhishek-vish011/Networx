     ...
     <div className={styles.container}>
      <div className={styles.mainContainer}>
        <div className={styles.mainContainer_left}>
            ...
            <p className={styles.typingtext}><span style={{color: "#134a71ff"}}>A True social media platform,</span> with stories no blufs !</p>
            <div onClick={()=>{
               router.push("/login")
        ...
        <div className={styles.mainContainer_right}>
          <img style={{borderRadius: "50%"}} src="Images/connectingImage.avif" alt="load"/>
        </div>
      </div>
     </div>
